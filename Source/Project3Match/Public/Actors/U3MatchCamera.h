...
public:	
	...
	UFUNCTION(BlueprintCallable, Category = U3MatchCameraHelper)
		FVector MoveCameraZ();
	FORCEINLINE void SetCameraSet(const bool& bIsSet) { this->bIsCameraSet = bIsSet; }

private:
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Meta = (AllowPrivateAccess = true), Category = U3MatchCameraVariable)
		class UGlobalGameInstance* GlobalGameInstance;
